(function () {
  ...
  var T = {
    en: {
      ...
      'index.news.kicker': 'Latest',
      'index.news.title': 'Updates',
      'index.news.item1.title': 'Layer Forge Studio · Best Seller',
      'index.news.item1.desc': 'Our layer-based texture editor hit bestseller status on the Unity Asset Store.',
      'index.news.item2.title': 'Layer Forge Studio launched',
      'index.news.item2.desc': 'Real-time brushes, effects, and one-click export · now on the Asset Store.',
      'index.news.item3.title': 'Tier Game Project',
      'index.news.item3.desc': 'Our debut title entered active development on the studio pipeline.',
    ...
    tr: {
      ...
      'index.featured.layerForgeRating': '5.0 · Asset Store',
      'index.news.kicker': 'Son',
      'index.news.title': 'Güncellemeler',
      'index.news.item1.title': 'Layer Forge Studio · En Çok Satan',
      'index.news.item1.desc': 'Katman tabanlı doku editörümüz Unity Asset Store\'da en çok satanlar arasına girdi.',
      'index.news.item2.title': 'Layer Forge Studio yayında',
      'index.news.item2.desc': 'Gerçek zamanlı fırçalar, efektler ve tek tıkla dışa aktarma · artık Asset Store\'da.',
      'index.news.item3.title': 'Tier Game Project',
      'index.news.item3.desc': 'İlk oyunumuz stüdyo pipeline\'ı üzerinde aktif geliştirmeye girdi.',
