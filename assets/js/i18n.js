(function () {
  var T = {
    en: {
      ...
      'games.steam.tagline': 'A 3D TPS survivor-like / bullet heaven with online co-op.',
      'games.steam.desc': 'Keep Chaos is on Steam. Wishlist now — be ready when chaos drops.',
      'games.steam.btn': 'Wishlist on Steam',
      'games.steam.btnShort': 'Add to Wishlist',
      'games.steam.releaseLabel': 'Release Date',
      'games.steam.releaseVal': 'To be announced',
      'games.steam.platform': 'Platform',
      'games.steam.platformVal': 'PC · Steam',
      'games.steam.developer': 'Developer',
      'games.steam.publisher': 'Publisher',
      'games.steam.reviewsLabel': 'All Reviews',
      'games.steam.reviewsVal': 'No user reviews',
      'games.steam.crumbAll': 'All Games',
      'games.steam.crumbAction': 'Action Games',
      'games.steam.hub': 'Community Hub',
      'games.steam.follow': 'Follow',
      'games.steam.ignore': 'Ignore',
      'games.steam.viewQueue': 'View Queue',
      'games.steam.unavailable': 'This game is not yet available on Steam',
      'games.steam.releaseSub': 'Interested? Add to your wishlist and get notified when it becomes available.',
      'games.steam.plannedRelease': 'Planned Release Date:',
      'games.steam.aboutTitle': 'About This Game',
      'games.steam.aboutText': 'Keep Chaos is a fast-paced low-poly 3D TPS survivor-like bullet heaven rogue-lite. Play solo or in local and online co-op for up to 4 players, fight enemy swarms, and drown the kingdom in chaos.',
      'games.steam.relevantTitle': 'Is this game relevant to you?',
      'games.steam.relevantSub': 'Similar to games you may know',
      'games.steam.tag1': 'Action',
      'games.steam.tag2': 'Co-op',
      'games.steam.tag3': 'Survivor-like',
      'games.steam.tag4': 'Bullet Heaven',
      'games.steam.tag5': 'Rogue-lite',
      'games.steam.similarTitle': 'Similar games',
      'games.steam.similarDesc': 'If you enjoy these survivor-likes, Keep Chaos may be your next run.',
      'games.steam.similarLike': 'Survivor-like · bullet heaven',
      'games.steam.btnSoon': 'Coming soon to Steam',
      'games.steam.btnSoonAria': 'Steam wishlist coming soon',
      'games.trailer.kicker': 'Trailer',
      'games.trailer.title': 'Official trailer',
      'games.trailer.desc': 'Keep Chaos · Steam announcement teaser.',
      'games.trailer.watch': 'Watch on YouTube',
      'games.trailer.iframeTitle': 'Keep Chaos official trailer',
      ...
      'games.press.btn': 'Open Press Kit',
      'games.press.gameSelect': 'Title',
      'games.press.gameSelectAria': 'Press kit title',
      ...
      'games.press.formatPng': 'PNG',
      'games.press.formatSvg': 'SVG',
      'games.press.formatAria': 'Logo format',
      ...
      'games.press.viewTrailerAria': 'Play trailer',
      ...
      'games.faq.a4': 'Keep Chaos is on Steam (PC). Wishlist from this page and join Discord for builds and early news.',
      ...
      'news.title': 'News',
      'news.desc': 'Devlogs, events, and announcements from the studio · Keep Chaos updates and behind-the-scenes notes.',
      'news.filterAria': 'Filter news',
      'news.filterAll': 'All',
      'news.filterDevlog': 'Devlog',
      'news.filterEvent': 'Events',
      'news.filterAnnouncement': 'Announcements',
      'news.empty': 'Nothing here yet for this filter · check back soon.',
      'news.aside': 'Want build updates and playtests first? Join the Discord community.',
      'news.asideBtn': 'Join Discord',
      'news.item.steam.title': 'Keep Chaos is live on Steam',
      'news.item.steam.desc': 'Steam wishlist opened on August 15. Add Keep Chaos now and be ready when chaos drops.',
      'news.item.steam.cta': 'Wishlist on Steam',
      'news.item.trailer.title': 'Official trailer is live',
      'news.item.trailer.desc': 'We published the official Keep Chaos trailer on August 15 · low-poly medieval chaos, co-op, and bullet heaven action.',
      'news.item.trailer.cta': 'Watch on YouTube',
      'news.item.coop.title': 'Online co-op development begins',
      'news.item.coop.desc': 'We started building online play on July 10. Local and online PvE co-op for up to four players is at the heart of Keep Chaos.',
      'news.item.coop.cta': 'Join Discord',
      'team.title': 'Team',
    ...
    tr: {
      ...
      'games.steam.tagline': 'Online koop destekli 3D TPS survivor-like / bullet heaven.',
      'games.steam.desc': 'Keep Chaos Steam\'de. Hemen wishlist\'e ekle — kaos düşmeden hazır ol.',
      'games.steam.btn': 'Steam\'de Wishlist',
      'games.steam.btnShort': 'Wishlist\'e ekle',
      'games.steam.releaseLabel': 'Çıkış Tarihi',
      'games.steam.releaseVal': 'Duyurulacak',
      'games.steam.platform': 'Platform',
      'games.steam.platformVal': 'PC · Steam',
      'games.steam.developer': 'Geliştirici',
      'games.steam.publisher': 'Yayıncı',
      'games.steam.reviewsLabel': 'Tüm İncelemeler',
      'games.steam.reviewsVal': 'Kullanıcı incelemesi yok',
      'games.steam.crumbAll': 'Tüm Oyunlar',
      'games.steam.crumbAction': 'Aksiyon Oyunları',
      'games.steam.hub': 'Topluluk Merkezi',
      'games.steam.follow': 'Takip Et',
      'games.steam.ignore': 'Yok Say',
      'games.steam.viewQueue': 'Kuyruğu Görüntüle',
      'games.steam.unavailable': 'Bu oyun henüz Steam\'de mevcut değil',
      'games.steam.releaseSub': 'İlgileniyor musun? İstek listenize ekleyin; oyun kullanılabilir olduğunda bildirim alın.',
      'games.steam.plannedRelease': 'Planlanan Çıkış Tarihi:',
      'games.steam.aboutTitle': 'Bu Oyun Hakkında',
      'games.steam.aboutText': 'Keep Chaos, hızlı tempolu low-poly 3D TPS survivor-like bullet heaven rogue-lite. Tek başına veya 4 kişiye kadar yerel ve online koop ile oyna, düşman sürüleriyle savaş, krallığı kaosa boğ.',
      'games.steam.relevantTitle': 'Bu oyun ilginizi çekiyor mu?',
      'games.steam.relevantSub': 'Tanıdığın oyunlara benzer',
      'games.steam.tag1': 'Aksiyon',
      'games.steam.tag2': 'Koop',
      'games.steam.tag3': 'Survivor-like',
      'games.steam.tag4': 'Bullet Heaven',
      'games.steam.tag5': 'Rogue-lite',
      'games.steam.similarTitle': 'Benzer oyunlar',
      'games.steam.similarDesc': 'Bu survivor-like\'ları seviyorsan Keep Chaos bir sonraki koşun olabilir.',
      'games.steam.similarLike': 'Survivor-like · bullet heaven',
      'games.steam.btnSoon': 'Çok yakında Steam\'de',
      'games.steam.btnSoonAria': 'Steam wishlist yakında',
      'games.trailer.kicker': 'Fragman',
      'games.trailer.title': 'Resmi fragman',
      'games.trailer.desc': 'Keep Chaos · Steam duyuru teaseri.',
      'games.trailer.watch': 'YouTube\'da izle',
      'games.trailer.iframeTitle': 'Keep Chaos resmi fragmanı',
      ...
      'games.press.btn': 'Press Kit\'i aç',
      'games.press.gameSelect': 'Oyun',
      'games.press.gameSelectAria': 'Press kit oyunu',
      ...
      'games.press.factTrailer': 'Fragman',
      'games.press.dlStudioLogo': 'Tier Studios logo',
      'games.press.dlLogo': 'Keep Chaos logo',
      'games.press.dlKeyArt': 'Key art',
      'games.press.dlTrailer': 'Resmi fragman',
      'games.press.download': 'İndir',
      'games.press.downloadAll': 'Tümünü indir (.zip)',
      'games.press.downloadAllHint': 'Beyaz ve siyah logolar (PNG + SVG) ile her iki key art dahil.',
      ...
      'games.press.formatPng': 'PNG',
      'games.press.formatSvg': 'SVG',
      'games.press.formatAria': 'Logo formatı',
      ...
      'games.press.viewTrailerAria': 'Fragmanı oynat',
      ...
      'games.faq.a4': 'Keep Chaos Steam\'de (PC). Bu sayfadan wishlist\'e ekle; build ve erken haberler için Discord\'a katıl.',
      ...
      'news.title': 'Haberler',
      'news.desc': 'Stüdyodan devlog, etkinlik ve duyurular · Keep Chaos güncellemeleri ve perde arkası notlar.',
      'news.filterAria': 'Haberleri filtrele',
      'news.filterAll': 'Tümü',
      'news.filterDevlog': 'Devlog',
      'news.filterEvent': 'Etkinlikler',
      'news.filterAnnouncement': 'Duyurular',
      'news.empty': 'Bu filtrede henüz içerik yok · yakında tekrar bak.',
      'news.aside': 'Build güncellemelerini ve playtestleri ilk sen görmek ister misin? Discord topluluğuna katıl.',
      'news.asideBtn': 'Discord\'a Katıl',
      'news.item.steam.title': 'Keep Chaos Steam\'de',
      'news.item.steam.desc': 'Steam wishlist 15 Ağustos\'ta açıldı. Hemen wishlist\'e ekle — kaos düşmeden hazır ol.',
      'news.item.steam.cta': 'Steam\'de Wishlist',
      'news.item.trailer.title': 'Resmi fragman yayında',
      'news.item.trailer.desc': 'Resmi Keep Chaos fragmanını 15 Ağustos\'ta yayınladık · low-poly orta çağ kaosu, koop ve bullet heaven aksiyonu.',
      'news.item.trailer.cta': 'YouTube\'da İzle',
      'news.item.coop.title': 'Online koop geliştirmesi başladı',
      'news.item.coop.desc': '10 Temmuz\'da online oyun geliştirmesine başladık. Yerel ve online PvE koop, Keep Chaos\'un kalbinde · dört oyuncuya kadar.',
      'news.item.coop.cta': 'Discord\'a Katıl',
      'team.title': 'Ekip',
  ...
  function loadPack(lang) {
    ...
    var url = '/assets/js/locales/' + encodeURIComponent(lang) + '.json?v=20260818play';
    return fetch(url)
