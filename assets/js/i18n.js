(function () {
  ...
  var T = {
    en: {
      ...
      'games.kc.positioning': 'A 3D TPS survivor-like / bullet heaven with online co-op — for fans of Vampire Survivors, Megabonk, and Sineus Arena Survivors.',
      ...
      'games.kc.f2': '<strong>Solo or 4-Player Online Co-op (PvE):</strong> Write your own legend alone, or build a squad with friends on the same couch (Local) or online — the online survivor-like vibe of titles like Sineus Arena Survivors.',
      ...
      'games.steam.desc': 'Keep Chaos is on Steam. Add it to your wishlist and be first in line when chaos drops.',
      ...
      'games.faq.q3': 'Does Keep Chaos have online co-op like Sineus Arena Survivors?',
      'games.faq.a3': 'Yes. Play solo or team up in up to 4-player local and online co-op PvE — built for the same online survivor-like niche as titles such as Sineus Arena Survivors.',
      ...
      'title.index': 'Tier Studios · Keep Chaos · Indie Survivor-Like Games & Unity Tools',
    ...
    tr: {
      ...
      'games.kc.positioning': 'Online koop destekli 3D TPS survivor-like / bullet heaven — Vampire Survivors, Megabonk ve Sineus Arena Survivors sevenler için.',
      ...
      'games.kc.f2': '<strong>Solo veya 4 Kişilik Online Koop (PvE):</strong> İster tek başına destan yaz, ister arkadaşlarınla aynı koltukta (Yerel) veya internet üzerinden (Çevrim İçi) ekibini kur — Sineus Arena Survivors tarzı online survivor-like kaos.',
      ...
      'games.steam.desc': 'Keep Chaos Steam\'de. Şimdi wishlist\'e ekle; kaos düştüğünde ilk sırada ol.',
      ...
      'games.faq.q3': 'Sineus Arena Survivors gibi online koop var mı?',
      'games.faq.a3': 'Evet. Solo veya en fazla 4 kişilik yerel ve çevrim içi koop PvE — Sineus Arena Survivors gibi online survivor-like niş için tasarlandı.',
      ...
      'title.index': 'Tier Studios · Keep Chaos · Indie Survivor-Like Oyunlar ve Unity Araçları',
